...
#define B_TERRAIN_TYPE_BOOST        FALSE // In Gen8, damage is boosted by 30% instead of 50%.
...
#define B_OVERWORLD_SNOW                FALSE // In Gen9+, overworld Snow will summon snow instead of hail.
